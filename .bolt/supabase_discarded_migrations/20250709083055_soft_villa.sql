/*
  # Dota 2 Helper Database Schema

  1. New Tables
    - `heroes` - Store hero information
    - `hero_moods` - Store hero mood associations
    - `hero_strengths` - Store hero strengths
    - `hero_weaknesses` - Store hero weaknesses  
    - `builds` - Store build information
    - `items` - Store item information for builds
    - `playstyle_dos` - Store playstyle do items
    - `playstyle_donts` - Store playstyle don't items
    - `playstyle_tips` - Store playstyle tips
